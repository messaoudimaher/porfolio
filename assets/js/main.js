...
(function ($) {
  ...
  jQuery(document).ready(function () {
    ...
    $(".contact-link, .portfolio-link, .about-link").on(
      "click",
      function (event) {
        var $anchor = $(this);
        $("html, body")
...
function sendEmail() {
  ...
  emailjs
    .sendForm(
      "service_lo9eqdv", // Replace with your Service ID
      "template_9kolzbl", // Replace with your Template ID
